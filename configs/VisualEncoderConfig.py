...
class cfg:
    def __init__(self) -> None:
        ...
        self.checkpoint_path = '/work3/s204138/bach-models/Kinetics_CTC_training/S3D_PHOENIX-46_epochs-11.745637_loss_0.266197_WER' # None  # if None train from scratch
