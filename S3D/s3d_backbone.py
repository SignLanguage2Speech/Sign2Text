...
from S3D.model import S3D, SepConv3d, BasicConv3d, Mixed_3b, Mixed_3c, Mixed_4b, Mixed_4c, Mixed_4d, Mixed_4e, Mixed_4f
...
class VisualEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        reps = self.head2(y3)
        probs = self.translation_layer(reps.view(-1, reps.size(2), reps.size(1)))
        return reps, probs